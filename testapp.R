...
#           need(!input$antennas3_0 %in% input$antennas1,"Last antenna in sequence can't contain first antenna in sequence")
#         )
...
if (interactive()) {
  ...
  server <- function(input, output, session) {
    Sequences_Server("SequencesTab1", All_Events = combinedData_df_list$All_Events, antennaChoices =  metaDataVariableNames$AntennaSiteShortHandCodes, mobileCodes = metaDataVariableNames$MobileRunFrontendCodes)
  }
