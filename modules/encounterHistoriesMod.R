#library(lubridate)
## need to 
EncounterHistories_UI <- function(id, Enc_release_data, df_list) {
  ns <- NS(id)
  tagList(
    ...
    tabsetPanel(
      tabPanel("Encounter Release History Summary Wide",
               ...
               sidebarLayout(
                 ...
                 mainPanel(hr(),
                           downloadButton(outputId = ns("download1"), label = "Save this data as CSV"),
                           hr(),
               ...
               sidebarLayout(
                 ...
                 mainPanel(
                   tabsetPanel(tabPanel("All Events",
                                        # hr(),
                                        # downloadButton(outputId = ns("download2"), label = "Save this data as CSV"),
                                        hr(),
...
EncounterHistories_Server <- function(id, Enc_release_data, df_list) {
  moduleServer(
    id,
