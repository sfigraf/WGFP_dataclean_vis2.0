...
Below is the encounter history of a Merganser tagged in 2024. Activity is excessive between Red Barn and Hitching Post, and doesn't follow a logical pattern. The Merganser was detected on the Hitching POst antenna below the dam, then was detected on an antenna above the dam without hitting other antennas between, as showin in the animation below. By recognizing movements patterns of known birds, we can apply this pattern to finding tags predated by birds.  
