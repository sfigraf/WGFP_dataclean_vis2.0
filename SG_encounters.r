...
####old pressure transducer file stuff
...
#ptdDataWide$dateTime <- lubridate::force_tz(ptdDataWide$dateTime, tzone = "UTC") 
# ptdDataWide$dateTime <- force_tz(ptdDataWide$dateTime, tzone = "America/Denver")
# 
# # 2. Now convert it to UTC (this will shift the actual hours to match UTC)
# ptdDataWide$dateTime <- with_tz(ptdDataWide$dateTime, tzone = "UTC")
start_date <- as.POSIXct("2022-04-02 00:00:00", tz = "UTC")
end_date   <- as.POSIXct("2022-04-21 08:00:00", tz = "UTC")

ptdDataWide <- ptdDataWide %>%
...
#normalize to the one where there is the most frequent difference
