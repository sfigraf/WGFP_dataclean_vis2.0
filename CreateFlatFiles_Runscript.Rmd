...
Biomark <- readRDS("./data/WGFP_Biomark_Raw_20260507.rds")
...
AllCombinedEvents <- All_combined_events_function(Stationary = Stationary_withUTMSDSTCorrected, Mobile = Mobile, Release = Release, Biomark = Biomark, Recaptures = Recaptures, 
                                                  allPressureTransducerDataWithDischarge = allPressureTransducerDataWithDischarge, windyGapContinuous = windyGapRenamed)
# x <- AllCombinedEvents$df_list$All_Events
# nrow(x) == nrow(DSTCorrectedData)
#DSTCorrectedData <- x
...
#x <- Movements_list$dailyMovementsTable1
