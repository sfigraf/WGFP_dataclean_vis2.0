...
enc_hist_wide_list <- Ind_tag_enc_hist_wide_summary_function(AllCombinedEvents$df_list$Recaps_detections, cleanedRelease, combined_events_stations, states_data_list$States_summarized, markerTags = unique(Cleaned_Marker_tags$TAG))
...
savingFilesEndMessage <- paste("Saving Files took", round(difftime(saveFilesEndTime, saveFilestartTime, units = "mins"),2), "minutes.")
