...
if(nrow(DailyDetectionsStationsStates$spatialList$noUTMS) > 0){
  problemNAtagsMessage <- paste0("The following tags could not be assigned stations because of an NA entry for UTMs: ", unique(DailyDetectionsStationsStates$spatialList$noUTMS$TAG),
                                         ".")
} else{
