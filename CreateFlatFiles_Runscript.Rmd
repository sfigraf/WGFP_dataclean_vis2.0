...
#make a df of tags that appear on every DF here as "high priority" tags
#incoporate into new QAQC tab on app 
avianPredationList <- list(
  "movingDownstream" = movingDownstream, 
  "movingUpstream" = movingUpstream, 
  "largeMovementsWithoutChannel" = enc_hist_wide_list$possibleAvianPredation, 
  "activeFishStates" = states$possibleAvianPredation
  )
