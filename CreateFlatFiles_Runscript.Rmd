...
if(nrow(DailyDetectionsStationsStates$spatialList$noState) > 0){
  problemNoStatetagsMessage <- paste0("The following tags could not be assigned a state (aside from TGM) because their boundary was outside the states polygon: ", unique(DailyDetectionsStationsStates$spatialList$noState$TAG),
                                         ".")
} else{
  problemNoStatetagsMessage <- ""
}
