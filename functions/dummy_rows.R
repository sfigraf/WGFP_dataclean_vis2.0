...
add_dummy_rows <- function(stationary1, biomark1, release1) {
  ###commenting out the stationary stuff for now; the connectivity channel has already been installed so we don't need test data
  #it's possible we won't need this logic again but you never know
  ...
  Biomark <- biomark1 %>%
    add_row(`Scan Date` = "2022-12-07",`Scan Time` = "12:52:10.810", `Download Date` = "9/16/2022",`Download Time` = "11:30:41",
            `Reader ID` = "B3",`Antenna ID` = 1,`HEX Tag ID` = "384.358D14F739",
    ...
    add_row(`Scan Date` = "2022-12-08",`Scan Time` = "12:52:10.810", `Download Date` = "9/16/2022",`Download Time` = "11:30:41",
            `Reader ID` = "B4",`Antenna ID` = 1,`HEX Tag ID` = "384.358D14F739",
            `DEC Tag ID` = "900.230000999999",`Temperature,C` = NA,`Signal,mV`= NA,`Is Duplicate`= "Yes",Latitude = NA,Longitude= NA,`File Name`= NA) %>%
    add_row(`Scan Date` = "2024-05-24",`Scan Time` = "12:52:10.810", `Download Date` = "9/16/2022",`Download Time` = "11:30:41",
            `Reader ID` = "B5",`Antenna ID` = 1,`HEX Tag ID` = "384.358D14F739",
            `DEC Tag ID` = "900.230000999999",`Temperature,C` = NA,`Signal,mV`= NA,`Is Duplicate`= "Yes",Latitude = NA,Longitude= NA,`File Name`= NA) 
  ...
  dummy_list <- list(#"Stationary" = Stationary, 
                     "Biomark" = Biomark, 
                     "Release" = release1
                     #"Ghost_tags" = ghost_dummy
                     )
  return(dummy_list)
}
