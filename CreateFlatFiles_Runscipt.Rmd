...
windyGap <- readNWISuv(siteNumbers = "09034250", #code for windy gap
                       parameterCd = c("00060"), #this is parameter code for discharge; more can be added if needed
...
allPressureTransducerDataWithDischarge_Long <- allPressureTransducerDataWithDischarge %>%
  pivot_longer(cols = c(contains("_"), "USGSDischarge"), names_to = "EnvVariable", values_to = "Reading")
...
allFlatFiles <- list(
  ...
  "USGSData" = USGSData, 
  "WGFPSiteVisitsFieldData" = WGFP_SiteVisits_FieldData
)
