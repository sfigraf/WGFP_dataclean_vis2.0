...
allPressureTransducerDataWithDischarge <- windyGap[,c("dateTime", "Flow_Inst", "Wtemp_Inst")] %>%
...
allPressureTransducerDataWithDischarge_Long <- allPressureTransducerDataWithDischarge %>%
  pivot_longer(cols = c(contains("_"), "USGSDischarge", "USGSWtempF"), names_to = "EnvVariable", values_to = "Reading")
