...
WindyGapAntennaSiteCode <- unique(wgfpMetadata$AntennaMetadata[wgfpMetadata$AntennaMetadata$AntennaSite == "Windy Gap Dam", "SiteCode"])
KaibabParkAntennaSiteCode <- unique(wgfpMetadata$AntennaMetadata[wgfpMetadata$AntennaMetadata$AntennaSite == "Kaibab Park", "SiteCode"])
RiverRunAntennaSiteCode <- unique(wgfpMetadata$AntennaMetadata[wgfpMetadata$AntennaMetadata$AntennaSite == "River Run", "SiteCode"])
FraserRiverCanyonAntennaSiteCode <- unique(wgfpMetadata$AntennaMetadata[wgfpMetadata$AntennaMetadata$AntennaSite == "Fraser River Canyon", "SiteCode"])
