...
enc_hist_wide_list <- Ind_tag_enc_hist_wide_summary_function(df_list$Recaps_detections, cleanRelease, combined_events_stations, states_data_list$States_summarized, markerTags = unique(Cleaned_Stationary_Marker_tags$TAG))
...
indiv_datasets_list <- list(
      ...
      "biomarkdata" = Biomark,
      "mobiledata" = Mobile,
      "recapdata" = cleanRecaptures,
      "releasedata" = cleanRelease,
      "ghostdata" = GhostTags,
