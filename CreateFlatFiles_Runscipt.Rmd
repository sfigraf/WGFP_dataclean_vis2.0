...
Stationary <- readRDS("./data/WGFP_Raw_20230801.rds")
...
Release <- read.csv("./data/WGFP_ReleaseData_Master_20230614.csv", na.strings = c(""," ","NA"), colClasses=c(rep("character",8), "numeric", "numeric",rep("character",8) ))
Recaptures <- read.csv("./data/WGFP_RecaptureData_Master_20230614.csv", na.strings = c(""," ","NA"), colClasses = c(rep("character", 9), rep("numeric", 2), rep("character", 8)))
