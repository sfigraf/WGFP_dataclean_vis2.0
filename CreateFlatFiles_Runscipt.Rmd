...
Stationary <- readRDS("./data/WGFP_Raw_20230623.rds")
...
print(paste("The whole document took", round(whole_doc_endTime-whole_doc_startTime,2), "minutes to run.  Flat Files are saved to the flat files directory and the data vis app is ready to run with the most updated data."))
```
