...
WindyGapAntennaSiteCode <- as.character(wgfpMetadata$AntennaMetadata[wgfpMetadata$AntennaMetadata$AntennaSite == "Windy Gap Dam", "SiteCode"])
KaibabParkAntennaSiteCode <- as.character(wgfpMetadata$AntennaMetadata[wgfpMetadata$AntennaMetadata$AntennaSite == "Kaibab Park", "SiteCode"])
RiverRunAntennaSiteCode <- as.character(wgfpMetadata$AntennaMetadata[wgfpMetadata$AntennaMetadata$AntennaSite == "River Run", "SiteCode"])
FraserRiverCanyonAntennaSiteCode <- as.character(wgfpMetadata$AntennaMetadata[wgfpMetadata$AntennaMetadata$AntennaSite == "Fraser River Canyon", "SiteCode"])
